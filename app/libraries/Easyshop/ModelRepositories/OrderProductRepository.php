...
{    
                                             ...
                                             $forBuyer = false)
    {
        ...
        if($filter){
            ...
            elseif (isset($userData['store_name']) && $userData['store_name']) {
                $query->where('es_member.store_name', 'LIKE', '%' . $userData['store_name'] . '%');
            }
            elseif (isset($userData['contactno']) && $userData['contactno']) {
            ...
            elseif (isset($userData['transactionid']) && $userData['transactionid']) {
                $query->where('es_order.transaction_id', 'LIKE', '%' . $userData['transactionid'] . '%');
            }
            elseif (isset($userData['invoiceno']) && $userData['invoiceno']) {
