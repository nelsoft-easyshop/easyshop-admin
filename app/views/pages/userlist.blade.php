        ...
        <div class="tbl-div">
            <table class="table table-striped table-hover tbl-my-style" id="tbl-user-list">
                ...
                <tr id="tr_{{{ $member->id_member }}}">
                    ...
                    <td id="{{{ $member->id_member . '_address'}}}">{{{ ($member->Address || $member->Address->City->location || $member->Address->Region->location || $member->Address->address) ? $member->Address->City->location . ' ' . $member->Address->Region->location . ' ' . $member->Address->address : '' }}}</td>
