...
@section('content')
  ...
  <script type="text/javascript"  src="{{{ asset('js/src/jquery-2.0.0.min.js') }}}"></script>
	<script type="text/javascript"  src="{{{ asset('js/src/sha1.js') }}}"></script>
	<script type="text/javascript"  src="{{{ asset('js/src/bootstrap.min.js') }}}"></script>
...
<!--                      <li><a href="#setSectionMainPanel" data-toggle="tab">Set Section Main Panel</a></li>
                     <li><a href="#setSectionHead" data-toggle="tab">Set Section Head</a></li>
                     <li><a href="#setSectionProduct" data-toggle="tab">Set Section Product</a></li>
 -->
                   ...
                   <form class="form-horizontal">
                      ...
                      <div class="form-group">
                          <div class="col-xs-offset-2 col-xs-10">
                              <a href="#"  class="btn btn-default text-center" id="btnSectionHead" data-index="{{$sectionId}}" data-userid="{{$userId}}">Submit</a>
                          </div>
                      </div>
                  </form>
          </div>
          ...
          <div id="collapse{{$collapse}}" class="panel-collapse collapse ">
            <div class="panel-body">
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                          <div class="col-xs-offset-2 col-xs-10">
                              <a class="btn btn-default text-center" id="btnSetSectionMainPanel" data-index="{{$sectionId}}" data-productindex="{{ $panelMainId }}" data-userid="{{$userId}}">Submit</a>
                          </div>
                      </div>
                  </form>
                  <hr/>
            ...
            <div class="panel-body">
              @foreach($section->product_panel as $product_panel)  
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                          <div class="col-xs-offset-2 col-xs-10">
                              <a class="btn btn-default text-center" id="btnSetSectionPanel" data-index="{{$sectionId}}" data-productindex="{{ $panelMainId }}" data-userid="{{$userId}}">Submit</a>
                          </div>
                      </div>
                  </form>
                  <hr/>
        ...
        <form method="post" action="https://easyshop.ph.feature/webservice/homewebservice/settext" onsubmit ="document.getElementById('hash').value = hex_sha1(document.getElementById('bannertext').value + document.getElementById('userId').value)">
         ...
         <div class="form-group">
                <div style='text-align:center;padding-top:10px;'>
                  <br/>
                   <a href="#"  class="btn btn-default text-center" id="submitBannerText"
                     >Submit</a>
                </div>
              </div>
          </fieldset>
...
<!-- end -->
  ...
  <script type="text/javascript" src="{{{ asset('js/src/cms.js') }}}"></script>
@stop